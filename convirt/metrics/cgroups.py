...
_ROOT = '/'
_PROCBASE = _ROOT + PROCFS
_CGROUPBASE = _ROOT + CGROUPFS
...
class Cpuacct(Reader):
    ...
    def update(self):
        data = _read_keyvalue(self._path + '/cpuacct.stat')
